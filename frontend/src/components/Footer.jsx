      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-12 border-b border-slate-800/80">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between">
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed max-w-sm mb-6">
                Elevating human potential through collaborative learning, skill sharing, and career growth opportunities. Empowering developers & creators worldwide.
              </p>
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link to="/skills" className="text-slate-400 hover:text-violet-400 transition-colors">
                  Skill Feeds
                </Link>
              </li>
              <li>
                <Link to="/opportunities" className="text-slate-400 hover:text-violet-400 transition-colors">
                  Opportunities
                </Link>
              </li>
              <li>
                <Link to="/contacts" className="text-slate-400 hover:text-violet-400 transition-colors">
                  Contacts
                </Link>
              </li>
            </ul>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/login" className="text-slate-400 hover:text-violet-400 transition-colors">
                  Sign In
                </Link>
              </li>
              <li>
                <Link to="/register" className="text-slate-400 hover:text-violet-400 transition-colors">
                  Create Account
                </Link>
              </li>
              <li>
                <a href="#privacy" className="text-slate-400 hover:text-violet-400 transition-colors">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="#terms" className="text-slate-400 hover:text-violet-400 transition-colors">
                  Terms of Service
                </a>
              </li>
            </ul>
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-slate-400 text-sm mb-4">
              Subscribe to get the latest tech skill trends and career updates directly in your inbox.
            </p>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <div className="flex flex-wrap items-center gap-4 text-center md:text-left">
            <span>
              &copy; {new Date().getFullYear()} <strong className="text-slate-300 font-semibold">SKILLORA</strong> by Team Innovexa. All rights reserved.
            </span>
          ...
          <div className="flex items-center gap-6">
            <span className="inline-flex items-center gap-1 text-slate-400">
              Built with <Heart className="w-3.5 h-3.5 text-rose-500 fill-rose-500" /> by Team Innovexa
            </span>
            <button
              onClick={scrollToTop}
